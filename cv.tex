...
\begin{tabular}[t]{@{}p{\textwidth-\rcollength}p{\rcollength}}
  e-mail: \href{mailto:piotr.szachewicz@gmail.com}{piotr.szachewicz@gmail.com} & \multirow{3}{*}{\includegraphics[scale=0.7]{photo.jpg}}\\
  web: \href{http://www.szachewicz.pl}{http://www.szachewicz.pl}\\
...
\textbf{Universitat Roviri i Virgili, Tarragona, Spain}
	\begin{outerlist}
...
\textbf{October 2014 - present} -- Sage -- \textbf{Senior Ruby on Rails Developer}\\(Barcelona, Spain).
\begin{itemize}
  \item Product: Sage One, accounting software, available in UK, Ireland, Canada and~USA.
  \item Tools: Ruby on Rails, RSpec, React, Git.
  \item \href{http://uk.sageone.com/}{http://uk.sageone.com/}
\end{itemize}
...
\begin{itemize}
\item \textbf{June 2016} -- ES2015: The Shape of JavaScript to Come (Code School).
\item \textbf{May 2016} -- Powering up with React (Code School).
...
\item \textbf{March 2013} -- Think Again: How to Reason and Argue (Coursera).
\item \textbf{November 2012} -- Machine Learning (Coursera).
\item \textbf{August 2012} -- Software Engineering for SaaS (Coursera).
\end{itemize}

\section{Languages} Polish (first language), English (Certificate in Advanced English), Spanish, German (basics)
